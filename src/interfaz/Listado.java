...
public class Listado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbldatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id ", "Nombres", "Apellidos", "Cedula", "Direccion", "Telefono"
            }
        ));
    ...
    public void cargardatos(ArrayList <Persona> listado){
        DefaultTableModel modelo = (DefaultTableModel) tbldatos.getModel();
        
        for(Persona p : listado){
            Object[] fila = {p.getId(),p.getNombres(),p.getApellidos(),p.getCedula(),p.getDireccion(),p.getTelefono()};
            modelo.addRow(fila);
        }
    }
